import fs from 'fs';
import gm from 'gm';              //GraphicsMagick for node
import Promise from 'bluebird';  //Bluebird is a full featured promise library with unmatched performance.
import iconv from 'iconv-lite';  //Convert character encodings in pure javascript.
...
class Memobird {
  ...
  print(str) {
    ...
    return Promise.resolve()
      .then(() => _.isArray(str) ? this.flatStrArray(str) : this._encode(str))
